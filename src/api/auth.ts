...
export const registrationEndpoint = async (data: User) =>
  await http.post('/auth/register', data);
export const authenticationEndpoint = async (data: User) =>
  await http.post('/auth/login', data);
export const forgotPasswordEndpoint = async (data: Unknown) =>
