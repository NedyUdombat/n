...
const CreateMicroPensionAccount = ({
  location: { pathname },
}: {
    ...
    <section className="create-pension-account">
      ...
      <div className="content">
        ...
        <p className="subtitle">
          Ensure you have the required documents for registration. This may take
          a while.
        </p>
        <ul className="list-items">
          <li className="list-item">
            ...
            <div className="details">
              ...
              <p className="info">
                One (1) recent coloured passport photograph taken against a
                white background. Face and ears must be completely visible.
              </p>
            </div>
          </li>
          <li className="list-item">
            ...
            <div className="details">
              ...
              <p className="info">
                A valid National Identity Number. You may also be asked to
                upload a scanned version of your NIN card.
              </p>
            </div>
          </li>
          <li className="list-item">
            ...
            <div className="details">
              ...
              <ul className="inner-list">
                <li className="inner-list-item">
                  National Identity Card or Enrolment Slip
                </li>
                <li className="inner-list-item">
                  Bio data page of current international passport
                </li>
                <li className="inner-list-item">
