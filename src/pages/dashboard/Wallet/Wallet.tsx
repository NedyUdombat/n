...
const Wallet = (): JSX.Element => {
  ...
  useEffect(() => {
    if (Object.keys(user).length > 1) {
      user?.wallets.length > 0 ? setHasWallet(true) : setHasWallet(false);
    }
  }, [user]);
          ...
          <div>
            {hasWallet === false ? (
              <section className="not-created-section card">
                ...
                />
                <p className="info">
                  You do not currently have a wallet, please click on the button
                  below to create one.{' '}
                </p>
                ...
                <div className="card-button-section">
                  <Link
                    to={{
                      pathname: ROUTE_URLS.CREATE_WALLET,
                      state: { from: location.pathname },
                    }}
                    className="create-wallet-link"
                  >
                    <button className="btn">Create Wallet</button>
                  </Link>
                </div>
              </section>
            ) : (
                  ...
                  <section className="account-cards-section">
                    <div className="accounts-section card">
                      ...
                      <div className="card-body">
                        <p className="details">
                          Top up your Awabah wallet directly from your other
                          bank accounts
                        </p>
